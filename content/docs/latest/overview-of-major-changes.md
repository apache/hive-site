...
+ [Rebalance compaction](/docs/latest/user/rebalance-compaction) (Hive ACID)
+ Compaction requests prioritization ([compaction pooling](/docs/latest/language/compaction-pooling))
