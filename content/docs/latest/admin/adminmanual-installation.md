...
HiveServer2 (introduced in Hive 0.11) has a new CLI called Beeline (see [Beeline – New Command Line Shell](/docs/latest/user/hiveserver2-clients#beeline--command-line-shell)). To use Beeline, execute the following command in the Hive home directory:
