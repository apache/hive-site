...
| show processlist                                                 | Displays the operations running on Hiveserver2 and provides session and operation details. It will help troubleshoot issues with the Hiveserver2 like identify inappropriate connections to terminate them, identify long running hive queries                                                                                                                                                                                                                                                                                                                                                                                                                         |
