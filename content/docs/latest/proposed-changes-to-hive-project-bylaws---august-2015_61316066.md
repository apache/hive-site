...
| ***Electing PMC Chair*** | ***The chair of the PMC serves for a one year term. When the one year term ends, or if the current chair of the PMC resigns, PMC members vote to recommend a new chair.*** | ***Single Transferable Voting*** | ***Active PMC members including the candidates*** | ***N/A*** | ***private@hive.apache.org*** |
