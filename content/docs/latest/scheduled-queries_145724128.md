...
* [System tables/views]({{< ref "#system-tables/views" >}})
	+ [information_schema.scheduled_queries]({{< ref "#information_schema-scheduled_queries" >}})
	+ [information_schema.scheduled_executions]({{< ref "#information_schema-scheduled_executions" >}})
