...
3. deserializes the byte[], prints it to convert it to Filter string
4. Converts Filter string to ExpressionTree using parser (Filter.g)
5. Walk ExpressionTree to create sql query (in direct sql)
