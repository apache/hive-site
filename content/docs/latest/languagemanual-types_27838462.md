...
* [Hive Data Types]({{< ref "#hive-data-types" >}})
	+ [Overview]({{< ref "#overview" >}})
		...
		- [Date/Time Types]({{< ref "#date/time-types" >}})
	...
	+ [Column Types]({{< ref "#column-types" >}})
		...
		- [Decimals]({{< ref "#decimals" >}})
			...
			* [Decimal Type Incompatibilities between Hive 0.12.0 and 0.13.0]({{< ref "#decimal-type-incompatibilities-between-hive-0-12-0-and-0-13-0" >}})
				+ [Upgrading Pre-Hive 0.13.0 Decimal Columns]({{< ref "#upgrading-pre-hive-0-13-0-decimal-columns" >}})
