...
* When "[hive.warehouse.subdir.inherit.perms](/docs/latest/user/configuration-properties#hivewarehousesubdirinheritperms)" flag is enabled in Hive, Hive will try to do all the following inheritances.
