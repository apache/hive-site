...
Explicit type conversion can be done using the cast operator as shown in the [#Built In Functions](/docs/latest/user/tutorial#built-in-functions) section below.
