...
* set [hive.orderby.position.alias](https://hive.apache.org/docs/latest/configuration-properties_27842758/#hiveorderbypositionalias)=true; (True is the default)
* set [hive.cbo.enable](https://hive.apache.org/docs/latest/configuration-properties_27842758/#hivecboenable)=true; (True is the default)
