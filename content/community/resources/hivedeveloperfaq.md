...
* See [Getting Started: Building Hive from Source](/development/gettingstarted-latest#building-hive-from-source) for detailed information about building Hive releases 0.13 and later with [Maven](http://maven.apache.org/).
* See [Installing from Source Code (Hive 0.12.0 and Earlier)](/docs/latest/admin/adminmanual-installation#installing-from-source-code-hive-0120-and-earlier) for detailed information about building Hive 0.12 and earlier with [Ant](http://ant.apache.org/).
