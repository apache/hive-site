...
The [TLP](http://hive.apache.org) and [bylaws](/community/bylaws/) votes passed, so Hive is now officially an Apache top level project! We are going ahead with moving the following resources:
